...
async function listNotifications(req, res) {
  try {
    ...
    console.log(
      "[listNotifications] Fetching notifications for userId:",
      userId,
    );
    ...
    console.log(
      "[listNotifications] Found notifications:",
...
async function notifyCourseEnrollment(req, res) {
  try {
    ...
    if (forumInstructors.length === 0) {
      ...
      console.log(
        "[notifyCourseEnrollment] Creating notification:",
        notification,
      );
    ...
    console.log(
      "[notifyCourseEnrollment] Creating notifications:",
      notifications,
    );
    ...
    return res
      .status(500)
      .json({ error: "Failed to send enrollment notification" });
  }
}
