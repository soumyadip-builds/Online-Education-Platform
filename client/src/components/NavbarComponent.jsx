      ...
      <Navbar bg="light" expand="lg" className="px-3">
        ...
        <Navbar.Collapse id="main-nav">
          ...
          <Nav className="me-auto">
            <Button className="nav-btn" onClick={() => navigate("/coursepage")}>
              Explore Courses
            </Button>
                ...
                {topSuggestions.map((course) => (
                  ...
                  >
                    ...
                    <div className="text-muted small">
                      {course.author} • {course.tags?.slice(0, 3).join(", ")}
                    </div>
                  </ListGroup.Item>
                ))}
          ...
          {auth.isAuthed ? (
            <Nav>
              ...
              >
                ...
                {role === "instructor" && (
                  <NavDropdown.Item onClick={() => navigate("/performance-instructor")}>
                    📈 Performance Metrics
                  </NavDropdown.Item>
                )}
                {role === "learner" && (
                  <NavDropdown.Item onClick={() => navigate("/performance-student")}>
                    📈 Performance Metrics
                  </NavDropdown.Item>
                )}
                <NavDropdown.Divider />
