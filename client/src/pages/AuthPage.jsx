...
// local auth helpers
import { getAuthUser, isAuthed, createLocalSession } from "../lib/authLocal";
...
const AuthPage = () => {
  ...
  useEffect(() => {
    ...
    else if (role === "learner") navigate(STUDENT_HOME_PATH, { replace: true });
  }, [navigate]);
  ...
  const handleRegisterSubmit = async (e) => {
    e.preventDefault();
    const errs = validateRegister(registerData); // client side validation
