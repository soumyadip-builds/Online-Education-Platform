                ...
                <div className="container py-5 py-md-6">
                    <div className="row g-4 align-items-start">
                        ...
                        <div className="col-12 col-md-6 col-lg-4">
                            ...
                            <p className="opacity-75 mb-4">
                                A focused learning flow—courses, assignments,
                                quizzes, and community—all in one stream.
                            </p>
                        ...
                        <div className="col-12 col-md-12 col-lg-4">
                            ...
                            <p className="opacity-75">
                                Subscribe for course drops, challenge reminders,
                                and product updates.
                            </p>

                            {/* Smaller email + button per your request */}
                            <form
                                className="newsletter row g-2"
                            ...
                            <div className="mt-3 small">
                                <span className="me-3 d-inline-flex align-items-center gap-1">
                                    ...
                                    <a
                                        className="link-smooth"
                                        href="mailto:support@edstream.app"
                                    >
                    ...
                    <div className="d-flex flex-column flex-md-row gap-2 justify-content-between align-items-center">
                        <div className="small opacity-75">
                            © {new Date().getFullYear()} EdStream. All rights
                            reserved.
                        </div>
                        ...
                        <ul className="nav small">
                            <li className="nav-item">
                                <a
                                    className="nav-link px-2 link-smooth"
                                    href="/terms"
                                >
                                    Terms
                                </a>
