...
import { enrollInCourse } from "../utils/userStorage"; // <- uses the helper you added
...
export default function CourseDetails() {
    ...
    // UPDATED: when enrolling, update the learner's coursesEnrolled in storage
    const handleEnroll = () => {
        ...
        if (me.role !== "learner") {
            // Optional UX: you can route mentors to a create/assign flow instead
            alert("Only learners can enroll in courses.");
            return;
        }

        // Persist to user storage (idempotent; no duplicates)
