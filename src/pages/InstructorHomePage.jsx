...
export default function InstructorHomePage({ authorName }) {
  ...
  // ----- HERO -----
  const slides = [
    { t: 'Inspire. Guide. Transform.', d: 'Every lesson you craft shapes a learner’s future.', bg: '#0d6efd', rightImg: '/images/HeroSlide_1.png' },
    { t: 'Design Learning That Lasts', d: 'Build courses that spark curiosity and confidence.', bg: '#6f42c1', rightImg: '/images/HeroSlide_2.png' },
    { t: 'Mentors Make Momentum', d: 'Your guidance turns effort into excellence.', bg: '#198754', rightImg: '/images/HeroSlide_3.png' },
  ];
    ...
    const load = async () => {
      ...
      try {
        ...
        const normalized = items.map((c, idx) => ({
          ...
          thumbnail: c.thumbnail ?? 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1200&q=60',
        ...
        const filtered =
          authorName && authorName.trim()
            ? normalized.filter((c) => (c.author ?? '').toLowerCase() === authorName.toLowerCase())
            : normalized;
    ...
    <div>
      ...
      <div className="instructor-home">
        ...
        <div className="position-relative">
          <div id="mentorCarousel" className="carousel slide" data-bs-ride="carousel">
            ...
            <button className="btn btn-light btn-lg rounded-circle carousel-ctrl position-absolute top-50 start-0 translate-middle-y" type="button" data-bs-target="#mentorCarousel" data-bs-slide="prev" aria-label="Previous">
              <i className="bi bi-chevron-left"></i>
            </button>
            <button className="btn btn-light btn-lg rounded-circle carousel-ctrl position-absolute top-50 end-0 translate-middle-y" type="button" data-bs-target="#mentorCarousel" data-bs-slide="next" aria-label="Next">
      ...
      <div className="py-5 bg-light border-top border-bottom">
        <div className="container">
          ...
          {coursesError && !coursesLoading && <div className="alert alert-danger">Error: {coursesError}</div>}
