  ...
  return (
    <div>
      ...
      <div className="instructor-home">
          ...
          <div className="row align-items-center gy-3">
            <div className="col-lg-5">
              ...
              <p className="text-muted mb-0">
                A quick glance at your impact and learner activity.
              </p>
            </div>
        ...
        {/* ===== Add Course Modal (unchanged UI; adds to UI only) ===== */}
        <div
              ...
              <div className="modal-body">
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setNc({ ...nc, description: e.target.value })
                    }
                  />
                </div>
                <div className="row g-3">
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      value={nc.category}
                      onChange={(e) =>
                        setNc({ ...nc, category: e.target.value })
                      }
                    />
                  </div>
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      value={nc.thumbnail}
                      onChange={(e) =>
                        setNc({ ...nc, thumbnail: e.target.value })
                      }
                    />
                  </div>
                </div>
