      ...
      case "frontend":
        return COURSES.filter(
          (c) =>
            ...
            c.tags.includes("typescript"),
        );
      case "backend":
        return COURSES.filter(
          (c) =>
            c.tags.includes("backend") ||
            c.tags.includes("api") ||
            c.tags.includes("express") ||
            c.tags.includes("node"),
        );
      case "devops":
        return COURSES.filter(
          (c) =>
            c.tags.includes("devops") ||
            c.tags.includes("docker") ||
            c.tags.includes("kubernetes") ||
            c.tags.includes("containers"),
        );
      case "testing":
        return COURSES.filter(
          (c) => c.tags.includes("testing") || c.tags.includes("jest"),
        );
      case "mobile":
        return COURSES.filter(
          (c) => c.tags.includes("react-native") || c.tags.includes("mobile"),
        );
      case "database":
        return COURSES.filter(
          (c) =>
            c.tags.includes("database") ||
            c.tags.includes("mongodb") ||
            c.tags.includes("orm"),
        );
      case "bestseller":
          ...
          {heroSlides.map((s, i) => (
            <div className="hero-slide" key={i} aria-hidden={heroIndex !== i}>
              ...
              <div className="hero-art">
                ...
                <img src={s.img} alt="Slide_1_Img" className="hero-image" />
              </div>
            </div>
          ))}
        </div>
          ...
          {categories.map((_, i) => (
            <button
              ...
              onClick={() => {
                setCatIndex(i);
                const w =
                  catRef.current?.firstChild?.getBoundingClientRect().width ||
                  320;
      ...
      <section className="certs">
        <div className="certs-inner">
          <div className="cert-copy">
            ...
            <p>
              Prep with comprehensive courses, practice tests, and exam voucher
              tips.
            </p>
            ...
            {certifications.map((c) => (
              <div className="cert-card" key={c.key}>
                <div className="cert-icon">
                  <img src={c.src} className="cert-icon"></img>
                </div>
